...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _svf_hs -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___svf_hs_H__
#define  ___svf_hs_H__
...
static float _svf_hs_faustpower2_f(float value) {
	return value * value;
}

class _svf_hs final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _svf_hs -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("filename", "svf_hs.dsp");
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("svf_hs");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = 1.0f - _svf_hs_faustpower2_f(fTemp0);
			fRec5[0] = fSlow1 + fConst2 * fRec5[1];
			float fTemp2 = std::tan(fConst3 * fRec5[0]) * std::sqrt(fTemp0);
			fRec6[0] = fSlow2 + fConst2 * fRec6[1];
			float fTemp3 = fTemp2 * (1.0f / fRec6[0] + fTemp2) + 1.0f;
			float fTemp4 = float(input0[i0]);
			float fTemp5 = fRec1[1] + fTemp2 * (fTemp4 - fRec2[1]);
			float fTemp6 = fTemp5 / fTemp3;
			fRec1[0] = 2.0f * fTemp6 - fRec1[1];
			float fTemp7 = fRec2[1] + fTemp2 * fTemp5 / fTemp3;
			fRec2[0] = 2.0f * fTemp7 - fRec2[1];
			float fRec3 = fTemp6;
			float fRec4 = fTemp7;
			float fTemp8 = 1.0f - fTemp0;
			output0[i0] = FAUSTFLOAT(fTemp0 * (fTemp4 * fTemp0 + fRec3 * fTemp8 / fRec6[0]) + fRec4 * fTemp1);
			float fTemp9 = float(input1[i0]);
			float fTemp10 = fRec7[1] + fTemp2 * (fTemp9 - fRec8[1]);
			float fTemp11 = fTemp10 / fTemp3;
			fRec7[0] = 2.0f * fTemp11 - fRec7[1];
			float fTemp12 = fRec8[1] + fTemp2 * fTemp10 / fTemp3;
			fRec8[0] = 2.0f * fTemp12 - fRec8[1];
			float fRec9 = fTemp11;
			float fRec10 = fTemp12;
			output1[i0] = FAUSTFLOAT(fTemp0 * (fTemp9 * fTemp0 + fRec9 * fTemp8 / fRec6[0]) + fRec10 * fTemp1);
			fRec0[1] = fRec0[0];
			fRec5[1] = fRec5[0];
			fRec6[1] = fRec6[0];
			fRec1[1] = fRec1[0];
	...
	#define FAUST_FILE_NAME "svf_hs.dsp"
	#define FAUST_CLASS_NAME "_svf_hs"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _svf_hs -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
